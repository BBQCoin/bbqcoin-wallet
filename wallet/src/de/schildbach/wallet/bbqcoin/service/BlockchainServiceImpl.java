...
package de.schildbach.wallet.bbqcoin.service;
...
import com.google.bbqcoin.discovery.PeerDiscoveryException;
import com.google.bbqcoin.store.BlockStore;
import com.google.bbqcoin.store.BlockStoreException;

import com.google.bbqcoin.store.SPVBlockStore;
import de.schildbach.wallet.bbqcoin.Constants;
import de.schildbach.wallet.bbqcoin.WalletApplication;
import de.schildbach.wallet.bbqcoin.WalletBalanceWidgetProvider;
import de.schildbach.wallet.bbqcoin.ui.WalletActivity;
import de.schildbach.wallet.bbqcoin.util.ThrottelingWalletChangeListener;
...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private static final String TAG = "Bbqcoin"+BlockchainServiceImpl.class.getSimpleName();
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
                ...
                try {
                    ...
                    Log.e("Bbqcoin", "There's no method: " + e.getLocalizedMessage());
                    Log.e("Bbqcoin", "Bbqcoinj issue.  We're going to ignore this for now and just try and return nicely.");
                    return;
                }
		...
		try
		{
            ...
            if (!blockChainFileExists) { // Starting from scratch
                try {
                    ...
                    Log.d("Bbqcoin", "Couldn't find checkpoints file; starting from genesis");
                }
            }
	...
	public void notifyWidgets()
	{
        ...
        try {
            ...
            Log.e("Bbqcoin", "App server appears dead - Runtime Exception when running getAppWidgetIds.  Returning..");
            return;
        }
