...
import com.google.bbqcoin.core.ProtocolException;
import com.google.bbqcoin.core.Sha256Hash;
import com.google.bbqcoin.core.Transaction;
import com.google.bbqcoin.core.VerificationException;
...
import de.schildbach.wallet.bbqcoin.util.Base43;
...
public final class TransactionActivity extends AbstractWalletActivity
{
	...
	private void updateView()
	{
		...
		if (nfcManager != null)
			NfcTools.publishMimeObject(nfcManager, this, Constants.MIMETYPE_TRANSACTION, tx.unsafeBbqcoinSerialize(), false);
	}
