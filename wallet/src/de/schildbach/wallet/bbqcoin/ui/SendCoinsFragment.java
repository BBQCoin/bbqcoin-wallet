...
import com.google.bbqcoin.core.AddressFormatException;
import com.google.bbqcoin.core.NetworkParameters;
import com.google.bbqcoin.core.Sha256Hash;
import com.google.bbqcoin.core.Transaction;
import com.google.bbqcoin.core.TransactionConfidence;
import com.google.bbqcoin.core.TransactionConfidence.ConfidenceType;
import com.google.bbqcoin.core.Wallet;
import com.google.bbqcoin.core.Wallet.BalanceType;
import com.google.bbqcoin.core.Wallet.SendRequest;
import com.google.bbqcoin.uri.BbqcoinURI;
import com.google.bbqcoin.uri.BbqcoinURIParseException;

import de.schildbach.wallet.bbqcoin.AddressBookProvider;
import de.schildbach.wallet.bbqcoin.Constants;
import de.schildbach.wallet.bbqcoin.WalletApplication;
import de.schildbach.wallet.bbqcoin.integration.android.BbqcoinIntegration;
...
public final class SendCoinsFragment extends SherlockFragment implements AmountCalculatorFragment.Listener
{
	...
	private final CurrencyAmountView.Listener amountsListener = new CurrencyAmountView.Listener()
	{
		...
		{
			dismissPopup();
            Log.d("Bbqcoin", "Amount: " + amountView.getAmount() + ", Fee: " + feeView.getAmount());
	...
	public void onActivityResult(final int requestCode, final int resultCode, final Intent intent)
	{
		if (requestCode == REQUEST_CODE_SCAN && resultCode == Activity.RESULT_OK)
		{
			...
			else
			{
				try
				{
					final BbqcoinURI bbqcoinUri = new BbqcoinURI(null, contents);
					final Address address = bbqcoinUri.getAddress();
					final String addressLabel = bbqcoinUri.getLabel();
					update(address != null ? address.toString() : null, addressLabel, bbqcoinUri.getAmount());
				}
				catch (final BbqcoinURIParseException x)
				{
	...
	private void handleGo()
	{
		...
		backgroundHandler.post(new Runnable()
		{
			public void run()
			{
                ...
                Log.d("Bbqcoin", "Transaction size is " + transaction.getOutputs().size());
				...
				handler.post(new Runnable()
				{
					public void run()
					{
						if (transaction != null)
						{
							...
							BbqcoinIntegration.transactionHashToResult(result, sentTransaction.getHashAsString());
