...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "bbqcoin".equals(scheme))
		{
			try
			{
				final BbqcoinURI bbqcoinUri = new BbqcoinURI(null, intentUri.toString());
				address = bbqcoinUri.getAddress().toString();
				addressLabel = bbqcoinUri.getLabel();
				amount = bbqcoinUri.getAmount();
			}
